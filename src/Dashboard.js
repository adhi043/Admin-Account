          ...
          <div class="card-body">
              <div class="row d-block d-xl-flex align-items-center">
                  ...
                  <div class="d-none d-sm-block">
                      <h2 class="h5">Customers</h2>
                      <h3 class="fw-extrabold mb-1">0k</h3>
                  </div>
      ...
      <div class="row">
          <div class="col-12 mb-4">
              <div class="card border-0 shadow">
                  ...
                  <div class="row align-items-center">
                      ...
                      <div class="col text-end"><Link to="#" class="btn btn-sm btn-primary">See all</Link></div>
                  </div>
                  </div>
          ...
          <div class="col-12 col-xxl-6 mb-4">
              <div class="card border-0 shadow">
                  ...
                  <Link to="#" class="btn btn-sm btn-primary">See all</Link>
                  </div>
                  <div class="card-body">
                  <ul class="list-group list-group-flush list my--3">
                      <li class="list-group-item px-0">
                          <div class="row align-items-center">
                              <div class="col-auto"> <Link to="#" class="avatar"><img class="rounded" alt="Image placeholder" src="assets/img/profile-picture-1.jpg" /></Link></div>
                              <div class="col-auto ms--2">
                              <h4 class="h6 mb-0"><Link to="#">Chris Wood</Link></h4>
                              ...
                              <Link to="#" class="btn btn-sm btn-secondary d-inline-flex align-items-center">
                      ...
                      <li class="list-group-item px-0">
                          <div class="row align-items-center">
                              <div class="col-auto"> <Link to="#" class="avatar"><img class="rounded-circle" alt="Image placeholder" src="assets/img/profile-picture-2.jpg" /></Link></div>
                              <div class="col-auto ms--2">
                              <h4 class="h6 mb-0"><Link to="#">Jose Leos</Link></h4>
                              <div class="d-flex align-items-center">
                      ...
                      <li class="list-group-item px-0">
                          <div class="row align-items-center">
                              <div class="col-auto"> <Link to="#" class="avatar"><img class="rounded-circle" alt="Image placeholder" src="assets/img/profile-picture-3.jpg" /></Link></div>
                              <div class="col-auto ms--2">
                              <h4 class="h6 mb-0"><Link to="#">Bonnie Green</Link></h4>
                              <div class="d-flex align-items-center">
                      ...
                      <li class="list-group-item px-0">
                          <div class="row align-items-center">
                              <div class="col-auto"> <Link to="#" class="avatar"><img class="rounded-circle" alt="Image placeholder" src="assets/img/profile-picture-4.jpg" /></Link></div>
                              <div class="col-auto ms--2">
                              <h4 class="h6 mb-0"><Link to="#">Neil Sims</Link></h4>
                              <div class="d-flex align-items-center">
                                  <div class="bg-danger dot rounded-circle me-1"></div>
                                  <small>Offline</small>
                              </div>
          ...
          <div class="col-12 col-xxl-6 mb-4">
              <div class="card border-0 shadow">
                  ...
                  <Link to="#" class="btn btn-sm btn-primary">See tasks</Link>
                  </div>
                  <div class="card-body">
                  <div class="row mb-4">
                      <div class="col-auto">
      ...
      <div class="col-12 px-0 mb-4">
          <div class="card border-0 shadow">
              <div class="card-header d-flex flex-row align-items-center flex-0 border-bottom">
                  ...
                  <div class="small mt-2"><span class="fas fa-angle-up text-success"></span> <span class="text-success fw-bold">0%</span></div>
                  </div>
      ...
      <div class="col-12 px-0 mb-4">
          <div class="card border-0 shadow">
              <div class="card-body">
                  ...
                  <div>
                      <Link to="#" class="d-flex align-items-center fw-bold">
                          #755 
