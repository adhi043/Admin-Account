...
const Customer = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://54.178.10.190:5000/seller/allSellers').then((res) => {  
            console.log(res.data)  
          const sale = res.data.sellers
          setCustomer(sale)   
        }
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                ...
                                <th class="border-bottom" scope="col">Sr.no</th>
                                    ...
                                    <th class="border-bottom" scope="col">Invoice Code</th>
                                </tr>
                            </thead>
                            <tbody>
                              {
                              ...
                              customer.map((c,index)=>(
                                <tr>
                                    ...
                                    <td class="fw-bolder text-gray-500">{c.name}</td>
                                    <td class="fw-bolder text-gray-500">{c.city}</td>
