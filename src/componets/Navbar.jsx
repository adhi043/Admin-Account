                ...
                <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item dropdown">
                            <Link class="nav-link text-dark notification-bell unread dropdown-toggle" data-unread-notifications="true" to="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                            ...
                            <div class="list-group list-group-flush">
                                <Link to="#" class="text-center text-primary fw-bold border-bottom border-light py-3">Notifications</Link> 
                                <Link to="#" class="list-group-item list-group-item-action border-bottom">
                                ...
                                <Link to="#" class="dropdown-item text-center fw-bold rounded-bottom py-3">
                        ...
                        <li class="nav-item dropdown ms-lg-3">
                            <Link class="nav-link dropdown-toggle pt-1 px-0" to="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
